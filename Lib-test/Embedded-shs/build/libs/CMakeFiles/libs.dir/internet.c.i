# 1 "F:/GitHub/Graduation-Project/Lib-test/Embedded-shs/libs/internet.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "F:/GitHub/Graduation-Project/Lib-test/Embedded-shs/libs/internet.c" 2
...
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.35\\pic\\include\\__size_t.h" 1 3
...
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.35\\pic\\include\\__null.h" 1 3
...
# 3 "F:/GitHub/Graduation-Project/Lib-test/Embedded-shs/libs/internet.c" 2
...
# 4 "F:/GitHub/Graduation-Project/Lib-test/Embedded-shs/libs/internet.c" 2
...
void internet_relay(uint8_t *payload, uint8_t size)
{
    ...
    if (dstMask > node.mask && internet_hasChild(packetHeader->destination))
    {
        if (packetHeader->destination & node.routingMask)
        {
            ...
            RF24_openReadingPipe(0, networkInfo.networkPipe);
    ...
    else
    {
        ...
        RF24_openWritingPipe(networkInfo.networkPipe);
        RF24_stopListening();
        _$_logline_str((char *)"payload =");
        _$_logline_str((char *)payload); Serial_write((uint8_t)'\n');
        RF24_write(payload, size);
