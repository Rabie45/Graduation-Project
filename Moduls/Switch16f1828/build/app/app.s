...
___lbdiv@dividend:	; 1 bytes @ 0x2
	global	__$_logline_bin$788
__$_logline_bin$788:	; 2 bytes @ 0x2
...
internet_setChannel@channel:	; 1 bytes @ 0x9
	global	_RF24_setPALevel$925
_RF24_setPALevel$925:	; 1 bytes @ 0x9
...
?___aldiv:	; 4 bytes @ 0x0
	global	_checkButton$193
_checkButton$193:	; 1 bytes @ 0x0
...
internet_setAddress@address:	; 1 bytes @ 0x3
	global	__$_logline_int$783
__$_logline_int$783:	; 2 bytes @ 0x3
	ds	1
...
internet_tx@packetHeader:	; 1 bytes @ 0x5
	global	__$_logline_int$784
__$_logline_int$784:	; 2 bytes @ 0x5
	ds	1
...
transport_udp_process@prop:	; 2 bytes @ 0x15
	ds	2
	global	transport_udp_process@response_245
transport_udp_process@response_245:	; 1 bytes @ 0x17
	ds	1
...
;!		 -> networkInfo(BANK1[6]), buffer_rx(BANK2[32]), network_pipe(BANK1[5]), props(BANK1[4]), 
;!
...
;!		 -> buffer_tx(BANK2[32]), 
;!
;!    transport_udp_process@response_245	PTR struct . size(1) Largest target is 32
;!		 -> buffer_tx(BANK2[32]), 
;!
...
l3791:	
	movlb 1	; select bank1
	comf	0+(_props)^080h+01h,w
	movlb 0	; select bank0
	movwf	(??_main+0)+0
	movf	(??_main+0)+0,w
	movlb 1	; select bank1
	movwf	0+(_props)^080h+01h
	line	119
...
;; *************** function _oxp_post *****************
;; Defined at:
;;		line 190 in file "F:/GitHub/Graduation-Project/Moduls/Switch16f1828/app/src/main.c"
;; Parameters:    Size  Location     Type
...
;; Defined at:
;;		line 138 in file "F:/GitHub/Graduation-Project/Moduls/Switch16f1828/app/src/main.c"
;; Parameters:    Size  Location     Type
;;  payload         1    wreg     PTR unsigned char 
;;		 -> buffer_rx(32), 
...
l3611:	
	...
	movwf	(??_transport_udp_process+0)+0
	movf	(??_transport_udp_process+0)+0,w
	movwf	(transport_udp_process@response_245)
	line	168
...
l3613:	
	...
	movf	indf1,w
	movwf	(??_transport_udp_process+0)+0
	movf	(transport_udp_process@response_245),w
	addlw	05h
	movwf	fsr1l
	movlw 1	; select bank2/3
	movwf fsr1h	
...
;; Defined at:
;;		line 240 in file "F:/GitHub/Graduation-Project/Moduls/Switch16f1828/app/src/main.c"
;; Parameters:    Size  Location     Type
;;  payload         1    wreg     PTR unsigned char 
;;		 -> buffer_rx(32), 
;;  size            1    4[BANK0 ] unsigned char 
...
;; Defined at:
;;		line 123 in file "F:/GitHub/Graduation-Project/Moduls/Switch16f1828/app/src/main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l2973:	
	movlw	01h
	movwf	(__$_logline_int$784)
	movlw	0
	movwf	((__$_logline_int$784))+1
	goto	l475
...
l475:	
	movf	(__$_logline_int$784+1),w
	movwf	(__$_logline_int$783+1)
	movf	(__$_logline_int$784),w
	movwf	(__$_logline_int$783)
	goto	l471
...
l2987:	
	movlw	030h
	movwf	(__$_logline_bin$788)
	movlw	0
	movwf	((__$_logline_bin$788))+1
	goto	l2991
...
l3231:	
	clrf	(_checkButton$193)
	incf	(_checkButton$193),f
	
l3233:	
	movf	(_checkButton$193),w
...
;; *************** function _ISR *****************
;; Defined at:
;;		line 186 in file "F:/GitHub/Graduation-Project/Moduls/Switch16f1828/app/src/main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
